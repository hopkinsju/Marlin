...
#define CUSTOM_MACHINE_NAME "PrintBuddy"
...
#define Z_RAISE_BEFORE_PROBING 15      // much the extruder will be raised before travelling to the first probing point.
...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT {79.96002,80.799919,4000,792,625,625,625}      // X, Y, Z, E0, E1, E2, E3 default steps per unit
